...
# Script number:				6.6
# File:							6 of 6
# Prerequisite script(s):       53mm, 53mm_analysis
# Prerequisite file(s):
...
def read_combined_stops():
    ...
    with open('outputs/mmodels_analysis/53mm/combined_stops.csv', 'rU') as file:
...
def read_codon_outputs():
    ...
    with open('outputs/mmodels_analysis/53mm//all_codons.csv', 'rU') as file:
        lines = file.readlines()
...
def write_to_file(combined, codons):
    ...
    output_file = open('outputs/mmodels_analysis/53mm/stats.csv', 'w')
