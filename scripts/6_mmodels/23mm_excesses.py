...
# Script number:				6.3
# File:							3 of 6
# Prerequisite script(s):       23mm, 23mm_analysis
# Prerequisite file(s):
...
def read_combined_stops():
    ...
    with open('outputs/mmodels_analysis/23mm/combined_stops.csv', 'rU') as file:
...
def read_codon_outputs():
    ...
    with open('outputs/mmodels_analysis/23mm//all_codons.csv', 'rU') as file:
        lines = file.readlines()
