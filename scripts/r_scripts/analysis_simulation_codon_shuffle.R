...
dir.create(file.path("graphs/simulation_codon_shuffle/"), showWarnings = FALSE)
...
excess_plots <- function() {
  ...
  ggsave(file='graphs/simulation_codon_shuffle/osc_excesses.pdf', plots, width=8, height=12, device=cairo_pdf)
}
...
excess_individual_osc_plots <- function(min, max) {
  ...
  ggsave(file='graphs/simulation_codon_shuffle/osc_individual_excesses_+1_+2.pdf', plots, width=12, height=8)
}
...
osc_vioplots <- function() {
  ...
  ggsave(file='graphs/simulation_codon_shuffle/osc_individual_gc_vioplots.pdf', plots, width=12, height=8, device=cairo_pdf)
}
