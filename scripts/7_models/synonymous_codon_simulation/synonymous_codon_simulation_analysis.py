...
# Prerequisite file(s):
# Description:					Analysis for the synonymous codon model allowing switch between coding block
...
output_analysis_directory = 'outputs/simulation_synonymous_codon_analysis/'
simulation_output_directory = 'outputs/simulation_synonymous_codon/'
