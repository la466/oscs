...
# Script number:				7.3
# File:							3 of 7
# Prerequisite script(s):       codon_shuffle, codon_shuffle_analysis
# Prerequisite file(s):
...
def read_combined_stops():
    ...
    with open('outputs/simulation_codon_shuffle_analysis/combined_stops.csv', 'rU') as file:
...
def read_codon_outputs():
    ...
    with open('outputs/simulation_codon_shuffle_analysis/all_codons.csv', 'rU') as file:
        lines = file.readlines()
...
def write_to_file(combined, codons):
    ...
    output_file = open('outputs/simulation_codon_shuffle_analysis/stats.csv', 'w')
