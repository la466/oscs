...
def read_combined_stops():
    ...
    with open('outputs/simulation_synonymous_site_analysis/combined_stops.csv', 'rU') as file:
...
def read_codon_outputs():
    ...
    with open('outputs/simulation_synonymous_site_analysis/all_codons.csv', 'rU') as file:
        lines = file.readlines()
...
def write_to_file(combined, codons):
    ...
    output_file = open('outputs/simulation_synonymous_site_analysis/stats.csv', 'w')
