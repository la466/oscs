...
# Prerequisite file(s):
# Description:					Analysis for the model simulating synonymous sites
...
output_analysis_directory = 'outputs/simulation_synonymous_site_analysis/'
simulation_output_directory = 'outputs/simulation_synonymous_site/'
